...
if ($_REQUEST['cadastra']) {
			...
			$sql = "UPDATE avaliacao SET nome='$titulo',objetivo='$objetivo',criador='$autor',qtde='$qtde',free='$free' WHERE id = '$id'";
			//echo $sql;
			if (mysql_query($sql)) {
		...
		<div id="principal">
			...
			?>
				...
				<div id="linha_form_auto">
					...
					<input type="checkbox" name="free" value="1" <?php if($gratuito == 1) { echo " checked"; } ?> class="form_style"> 
				</div>

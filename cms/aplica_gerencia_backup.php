...
while($linha = mysql_fetch_array($sql)) {
    ...
    $resp = $resp."a";
    mysql_query("UPDATE aplicacoes SET respostas = '$resp' WHERE id = '$id'");
}
}
		...
		<div id="principal">
			...
			<?php
                ...
                if($_REQUEST["mes"] != ""){
					$mes = $_REQUEST["mes"];
					if($where == "" ){
						$where .= " WHERE MONTH(aplicacoes.data_aplic) = '$mes' and YEAR(aplicacoes.data_aplic) = '2012'";
					}else{
						$where .= " and MONTH(aplicacoes.data_aplic) = '$mes' and YEAR(aplicacoes.data_aplic) = '2012'";
					}
				}

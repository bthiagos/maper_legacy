...
$cods = implode("/",$_POST["aplicacoes"]);
$where_cod = implode("' OR ".$t.".id = '",$_POST["aplicacoes"]);
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="perfil_cargos_grupos_gerar.php?gerar=1&cod=<?=$cod?>&commit=<?=$commit?>" method="post" onSubmit="return validaForm()" name="cadastro" enctype="multipart/form-data">
			<input type="hidden" value="<?=$cods?>" name="cods" />

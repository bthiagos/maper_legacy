...
if ($_REQUEST['apagar']) {
	...
	$sql = "DELETE FROM conteudo_aplicacoes WHERE id=".$_REQUEST['cod'];
	if (mysql_query($sql)) {
...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert($msgErro);
				...
				$sql = "INSERT INTO conteudo_aplicacoes (titulo, lista) VALUES ('$titulo','$lista')";
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="caixa_table" style="margin-top: -30px;">
			...
			<?
				$sql = "SELECT * FROM conteudo_aplicacoes ORDER BY id DESC";

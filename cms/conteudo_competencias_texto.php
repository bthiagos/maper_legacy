...
if ($_REQUEST['cadastra']) {
	...
	if (!($_POST["conteudo1"] == "")) {
		...
		$ok = 0;
		$msgErro .= "CAMPO TEXTO OBRIGATÓRIO".'\n';
	}
	...
	if (!$ok) {
		...
		alert($msgErro);
				...
				$sql = "UPDATE conteudo_competencias_texto SET texto = '$conteudo1' WHERE id = '1'";
				 
				// Confirmacao de insert
				if (mysql_query($sql)) { 
					alert("TEXTO DAS COMPETÊNCIAS ALTERADO COM SUCESSO!");
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<?php
				$sql = mysql_query("SELECT * FROM conteudo_competencias_texto");
			...
			<div id="caixa_form">
				...
				<div id="linha_form" style="margin-top: 0px;">
					<div id="label" style="valign: top;"> <span class="label_fonte">Texto Inicial: </span> </div>

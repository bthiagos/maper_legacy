		...
		<div id="principal">
			...
			<?
				...
				if($organizacaon){
					...
					$aplicacaoINNER = " INNER JOIN gerador_tickets ON aplicacoes_commit.ticket = gerador_tickets.numero_ticket INNER JOIN gerador_tickets_pedidos ON gerador_tickets.num_pedido = gerador_tickets_pedidos.id ";
					$campoINNER = " gerador_tickets_pedidos.nome_cliente, ";

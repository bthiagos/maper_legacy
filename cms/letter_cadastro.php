...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert("Algum campo foi preenchido incorretamente ou está em branco, tente novamente!");
			...
			$sql = "INSERT INTO ce_letter (titulo,msg,tipo) values ('$titulo','$texto',1)";
			// Confirmacao de insert

			if (mysql_query($sql)) {
				alert("Newsletter cadastrada com sucesso!");
				redireciona("letter_cadastro.php");
			}
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<div id="info">
				<img src="imagens/cadastro_tipoTexto.gif" alt="Cadastro de Newsletter" />
			</div>
			<!-- INICIO - DIV info - Barra de informacao -->
			
			<form action="letter_cadastro.php?cadastra=1" method="post" name="cadastro">
			...
			<div id="caixa_form">
				...
				<div id="linha_form_auto">
					<div id="label"> <span class="label_fonte">Mensagem: </span> </div><textarea rows="10" cols="60" name="texto"><?=$texto?></textarea>
				</div>
			...
			<!-- INICIO - DIV info - Barra de informacao -->
			<div id="info">
				<img src="imagens/gerenciamento_tipoTexto.gif" alt="Gerenciamento de Newsletters" />
			</div>
			<!-- INICIO - DIV info - Barra de informacao -->
			...
			<?
				$sql = "SELECT * FROM ce_letter WHERE tipo=1 ORDER BY codigo";
			...
			?>					
					...
					?>
						...
						<td align="center" ><a href="letter_cadastro.php?apagar=1&cod=<?=$linha["codigo"]?>"><img src="imagens/icon_apagar.gif" onclick="javascript: return confirm('Deseja realmente excluir a Newsletter?')" alt="Apagar" border="0"></a></td>
					</tr>
				<?
				}
				?>

...
if ($_REQUEST['apagar']) {
	...
	if (mysql_query($sql)) {
		$frase = "Grupo excluida com sucesso!";
	}
...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert("Algum campo foi preenchido incorretamente ou está em branco, tente novamente!");
			...
			$sql = "INSERT INTO grupos (nome,id_organizacao,commit) VALUES ('$texto',$orga,'$insert_commit')";
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="grupos.php?cadastra=1" method="post" name="cadastra" enctype="multipart/form-data">
			...
			<div id="linha_form">
				...
				if ($_SESSION["per_adm"] == 5555) {
					...
					$select_commit_orga = " WHERE organizacoes.commit=1 ";
				}
			...
			?>			
				...
				<tr height="30" class="cel_fonte" onMouseOver="this.className='cel_fonte_hover'" onMouseOut="this.className='cel_fonte'">
						...
						<td align="center" width="1%" nowrap>
							<!-- Icone de edicao -->
							<a href="grupos_alt.php?alterar=1&cod=<?=$linha["id"]?>">
								<img src="imagens/icon_editar.gif" title="Editar" alt="Editar" border="0">
							</a>
							
							<!-- Icone de Exclusao -->
							<a href="grupos.php?apagar=1&cod=<?=$linha["id"]?>">

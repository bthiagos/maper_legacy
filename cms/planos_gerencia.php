	...
	if (!$ok) {
		...
		alert("Algum campo foi preenchido incorretamente ou está em branco, tente novamente!");
			...
			if (mysql_query($sql)) {					
				...
				redireciona("planos_gerencia.php");
			}
	} 
}
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="planos_gerencia.php?cadastra=1" method="post" name="cadastra" enctype="multipart/form-data">
			...
			<div id="linha_form">
				<div id="label"> <span class="label_fonte">Nome do Plano: </span> </div><input type="text" size="50" name="plano" class="form_style">
			
			</div>
			
			<div id="linha_form">
				<div id="label"> <span class="label_fonte">Número de teste: </span> </div><input type="text" size="50" name="quantidade" class="form_style">
			
			</div>
			
			<div id="linha_form">
				<div id="label"> <span class="label_fonte">Valor do plano: </span> </div><input type="text" size="30" name="valor" class="form_style">
			
			</div>
			
				<div id="linha_form_auto">
					<div id="label"> <span class="label_fonte">Descrição: </span> </div><textarea rows="20" cols="70" name="descricao" class="form_style"><?=$depoimento?></textarea>
				</div>	
			...
			?>			
				...
				<tr height="30" class="cel_fonte" onMouseOver="this.className='cel_fonte_hover'" onMouseOut="this.className='cel_fonte'">
						...
						<td align="center" width="1%" nowrap>
							...
							<!-- Icone de Exclusao -->
							<a href="planos_gerencia.php?apagar=1&cod=<?=$linha["id"]?>">

...
?>
<table width="100%" border="0" cellspacing="0" bordercolor="#000000" align="center" style="border: 1px #000000 solid; background-image: url(fun_table.gif); background-repeat: repeat-y; margin-top: 0px;">
  <tr>
    ...
    <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="52%"><span style="font-size:7px;"><strong>Nasc: </strong><?php echo $pNasc;?><br />
...
//	echo "<p><b>Compet̻ncias:</b></p>";
	while ($i<20){ 
		...
		<? echo $competencias[$i]; ?>
		</td><td align="left" style="font-size:7px; font-align:center;"><div style="width: 100%; text-align: justify">
...
<p style="margin-top: 10px;"><center><img src="http://appweb.com.br/cms/graficos/<?=$codigo_id2?>" width="487" height="358"/></center></p>
<br/>

<p style="margin-top: 10px;"><center><img src="http://appweb.com.br/cms/graficos/<?=$codigo_id?>" width="487" height="358"/></center></p>

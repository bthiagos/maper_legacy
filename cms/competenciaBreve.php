...
<?
	...
	$sql = "SELECT * FROM competenciasBreve";
...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		$sql = "UPDATE competenciasBreve SET resumo='$resumo' WHERE id = 1";
		if (mysql_query($sql)) {
			alert("Dados alterados com sucesso!");
			redireciona("competenciasBreve.php");
		}
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="competenciasBreve.php?cadastra=1" method="post" onSubmit="return validaForm()" name="cadastro">

...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert($msgErro);
				...
				$sql = "UPDATE conteudo_aplicacoes_texto SET texto = '$conteudo1' WHERE id = '1'";
				 
				// Confirmacao de insert
				if (mysql_query($sql)) { 
					alert("TEXTO DAS APLICAÇÕES ALTERADO COM SUCESSO!");
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<?php
				$sql = mysql_query("SELECT * FROM conteudo_aplicacoes_texto");

...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert($msgErro);
			...
			$sql = "UPDATE coach_dicas SET titulo='$titulo',subtitulo='$subtitulo',descricao='$descricao',conteudo='$conteudo',foto='$arquivo' WHERE id = '$id'";
			...
			if (mysql_query($sql)) {
				...
				// Gravando dados no banco
					$sql = "UPDATE coach_dicas SET titulo='$titulo',subtitulo='$subtitulo',descricao='$descricao',conteudo='$conteudo' WHERE id = '$id'";
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<?php
				//EDIT
				$sql = mysql_query("SELECT * FROM coach_dicas WHERE id = '$id'");

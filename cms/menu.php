...
if(($permissao == "99991") or ($permissao == "99992") or ($permissao == "99992")){?>
        ...
        <div>
            ...
            <a href="inscritos.php">Neuroliderança</a>
...
<? if($permissao != "1111"  and $permissao != "6666"  and $permissao != "2222") { ?>
        ...
        <div>
          ...
          <?php } ?>    
            ...
            <a href="aplica_gerencia.php">Visualizar Aplicações</a>
            ...
            <? } ?>
              ...
              <a href="grupoMont_venda.php">Gráficos em Grupo - Vendedores</a>
              <a href="grupoMont_operacional.php">Gráficos em Grupo - Operacional</a>
              <a href="feedbackGrupos.php">Gráficos em Grupo - Feedbacks</a>
           ...
           <? if($permissao != "3333" and $permissao != "2222"){?>
            ...
            <? if(($permissao == "99991") or ($permissao == "99992")) { ?>
                ...
                <a href="questoes_en_es.php">Traduções Inglês/Espanhol das Questões</a>

	            <a href="feedbacks_en_es.php">Traduções Inglês/Espanhol dos Feedbacks</a>

              <a href="competencias_en_es.php">Traduções Inglês/Espanhol das Competências</a>
              <a href="competenciasBreve_en_es.php">Traduções Inglês/Espanhol das Descrições das Competências</a>

              <a href="grupoMont_en_es.php">Traduções Inglês/Espanhol dos Grupos</a>
        ...
        <div>
            ...
            <a href="aplica_gerencia_aplicativo.php">Visualizar Aplicacões (Aplicativo de Celular)</a>
            <a href="codigos_promocionais.php">Códigos Promocionais</a>
        </div>
        <? } ?>
...
<? if($permissao == "2222") { ?>
        ...
        <div>
            ...
            <a href="aplicacao_super.php">Visualizar Aplicacões</a>
...
<? } ?>
        ...
        <div>
			...
			<a target="_blank" href="http://appweb.com.br/cms/Interpretacao_resultadosAPP.ppt">Tutorial para o Interpretação de Resultados do APP.</a>

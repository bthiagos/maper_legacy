...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<div id="info">
				<img src="imagens/barra_gera_ticket.gif" alt="Gera��o de Tickets" />
			</div>
            <? $id_pesq = $_GET["id"]; ?>
			<!-- INICIO - DIV info - Barra de informacao -->
			...
			<div id="caixa_form">
				...
				<div id="linha_form">
					<div id="label" > <span class="label_fonte">Apartir de: </span> </div>
                    <select style="font-size: 10px; width: 700px" name="anolimitconsulta">
                          <option value="">Todos</option> 
                          <?php for ($ano=2012; $ano <= date("Y"); $ano++) { ?>

	...
	<div class="wrapper fadeInDown">
	  <div id="formContent">
	    ...
	    <form action="valida_logon.php" method="POST">
	      <input id="login" class="fadeIn second" type="text" name="login" value="" placeholder="Usuário ou E-mail">
	      <input type="password" name="senha" id="password" class="fadeIn third" placeholder="Senha">
	      <input type="submit" class="fadeIn fourth" value="Logar">
	    </form>

	    <!-- Remind Passowrd -->
	    <div id="formFooter">
	      <a class="underlineHover" href="esqueci-a-senha.php">Esqueceu a Senha?</a>
	    </div>

...
$string_notas = implode("|", $competencias);
 ...
 $array_json = array(
    'nome' => $nome,
    'cpf' => $cpf_candidato,
    'organizacao_candidato' => $organizacao_candidato,
    'grupo_candidato' => $grupo_candidato,
    'datanascimento_candidato' => $datanascimento_candidato,
    'datateste_candidato' => $datateste_candidato,
    'cargo_candidato' => $cargo_candidato,
    'competencias' => $string_competencias,
    'notas' => $string_notas
);

echo json_encode(utf8ize($array_json));

...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		$sql = "UPDATE origem SET textoCompleto='$textoCompleto' WHERE id = 1";
		if (mysql_query($sql)) {
			alert("Dados alterados com sucesso!");
			redireciona("origem.php");
		}
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="origem.php?cadastra=1" method="post" onSubmit="return validaForm()" name="cadastro">

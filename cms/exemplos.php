...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		$sql = "UPDATE exemplos SET textoCompleto='$textoCompleto' WHERE id = 1";
		if (mysql_query($sql)) {
			alert("Dados alterados com sucesso!");
			redireciona("exemplos.php");
		}
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="exemplos.php?cadastra=1" method="post" onSubmit="return validaForm()" name="cadastro">

...
if ($_REQUEST['apagar']) {
	...
	$sql = "DELETE FROM coach_noticias WHERE id=".$_REQUEST['cod'];
	if (mysql_query($sql)) {
...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert($msgErro);
			...
			$sql = "INSERT INTO coach_noticias (titulo,subtitulo,descricao,conteudo,foto) 
			...
			if (mysql_query($sql)) {
				...
				$sql = "INSERT INTO coach_noticias (titulo,subtitulo,descricao,conteudo) 
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="caixa_table" style="margin-top: -30px;">
			...
			<?
				$sql = "SELECT * FROM coach_noticias";
			...
			?>					
					<tr height="30" class="cel_fonte" onMouseOver="this.className='cel_fonte_hover'" onMouseOut="this.className='cel_fonte'">
						...
						<td align="center" >
							<a href="coach_cnoticias_alt.php?edit=1&id=<?=$linha["id"]?>"><img src="imagens/icon_editar.gif" alt="Editar" border="0"></a>

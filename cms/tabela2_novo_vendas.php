...
while($comp = mysql_fetch_array($comp_sql)) {
    ...
    if($comp["competencias_id"] == 4) {
        $comp["descricao".$complang] = "Persuasão";
    }

    if($comp["competencias_id"] == 3) {
        $comp["descricao".$complang] = "Capacidade de Acompanhamento";
    }

    if($comp["competencias_id"] == 13) { 
        $comp["descricao".$complang] = "Capacidade para Lidar com Objeções";
    }
...
function base10 ($pCompentencia, $pNota){
            ...
            if(mysql_result($sql, 0, "base10_vendas") != null) {
...
<table border="0" align="center" width="800" cellspacing="20" border="0"> 
    ...
    <tr>
        ...
        <td width="163" height="400" class="coluna_auzl<?=$complang?>" style="padding-right: 3px; padding-left: 3px;" valign="top"><br/>
            ...
            <div style="font-family: Arial; font-size: 16px; color: #0e80b4; text-decoration: none; text-align: center;"><br/><strong><?=$titulo?></strong></div>
        ...
        <td width="163" height="400" class="coluna_amarela<?=$complang?>" valign="top"><br/>
            ...
            <div style="font-family: Arial; font-size: 16px; color: #3fbeb2; text-decoration: none; text-align: center;"><br/><strong><?=$titulo?></strong></div>
        ...
        <td width="163" height="400" class="coluna_vermelho<?=$complang?>" valign="top"><br/>
            ...
            <div style="font-family: Arial; font-size: 16px; color: #58479d; text-decoration: none; text-align: center;"><br/><strong><?=$titulo?></strong></div>

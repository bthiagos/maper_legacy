...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert($msgErro);
				...
				$sql = "UPDATE conteudo_sobre SET sobre = '$conteudo1' WHERE id = '1'";
				 
				// Confirmacao de insert
				if (mysql_query($sql)) { 
					alert("SAIBA MAIS ALTERADO COM SUCESSO!");
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<?php
				$sql = mysql_query("SELECT * FROM conteudo_sobre");
			...
			<div id="caixa_form">
				...
				<div id="linha_form" style="margin-top: 0px;">
					<div id="label" style="valign: top;"> <span class="label_fonte">Saiba mais sobre a APP Web: </span> </div>

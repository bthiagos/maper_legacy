...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="grupoMont_operacional.php" method="POST">
					...
					<div id="label"> <span class="label_fonte">Grupos:  <i>(Pressione CTRL para escolher varias opções)</i></span> </div>
						...
						if($id2){
				          ...
				          $sql = "SELECT
									...
									FROM grupos LEFT JOIN organizacoes ON grupos.id_organizacao = organizacoes.id
			...
			<form action="grupoMont2_operacional.php?lang=pt" target="_blank" name="myform" id="form-gerar" method="POST" >
			...
			<div style="text-align: center">
				<label onclick="$('#form-gerar').attr('action','grupoMont2_operacional.php?lang=br')" style="display: inline-block; font-family: Arial; font-size: 14px; color: #727272"><input type="radio" name="linguagem" checked  /> Portugues</label>
				<label onclick="$('#form-gerar').attr('action','grupoMont2_operacional.php?lang=es')" style="display: inline-block; font-family: Arial; font-size: 14px; color: #727272"><input type="radio" name="linguagem"   /> Espanhol</label>
			</div>

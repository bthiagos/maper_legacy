...
<?
				...
				$dir = "/home/appweb/public_html/cms/graficos_pesquisa/$nome_pasta/";
...
<table width="100%" border="0" align="left" cellspacing="5" cellpadding="5">
			...
			<? if($formato_alternativa[$i] == 2){
					...
					$url = "http://www.appweb.com.br/cms/gerar_grafico_pesquisa.php?item=$p&pergunta=$p&alternativa=$alt_trim&resposta=$respostas[$i]&pasta=$nome_pasta&tiporesp=$tiporesp";			
			...
			?>
						<tr>
								<td><img src="graficos_pesquisa/<?=$nome_pasta?>/iel.png" ></td>
						</tr>
					
				<?	}else{?>
						<tr>
								<td><img src="graficos_pesquisa/<?=$nome_pasta?>/<?=$nome_imagem?>.png" ></td>
						</tr>

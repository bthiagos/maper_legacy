...
<?
	...
	$sql = "SELECT * FROM aplicacoesTextos";
...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		$sql = "UPDATE aplicacoesTextos SET resumo='$resumo' WHERE id = 1";
		if (mysql_query($sql)) {
			alert("Dados alterados com sucesso!");
			redireciona("aplicacoes.php");
		}
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="aplicacoes.php?cadastra=1" method="post" onSubmit="return validaForm()" name="cadastro">

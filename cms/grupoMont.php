...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="grupoMont.php" method="POST">
			...
			<form action="grupoMont2.php?lang=pt" target="_blank" name="myform" id="form-gerar" method="POST" >
			...
			<div style="text-align: center">
				<label onclick="$('#form-gerar').attr('action','grupoMont2.php?lang=br')" style="display: inline-block; font-family: Arial; font-size: 14px; color: #727272"><input type="radio" name="linguagem" checked  /> Portugues</label>
				<label onclick="$('#form-gerar').attr('action','grupoMont2.php?lang=es')" style="display: inline-block; font-family: Arial; font-size: 14px; color: #727272"><input type="radio" name="linguagem"   /> Espanhol</label>
			</div>

...
//zerotres seis seteoito novedez= 0;
...
// Some data
$data = array($zerotres,$media,$seis,$seteoito,$novedez);
...
$item = array();
$desc = mysql_query("SELECT * FROM feedbacks_grupo WHERE item = 'Percepчуo'");
...
$p1->SetLegends(array("$zerotres%% ".$item[0],"$media%% ".$item[1],"$seis%% ".$item[2],"$seteoito%% ".$item[3],"$novedez%% ".$item[4]));
$graph->legend->SetFont(FF_FONT2,FS_NORMAL,16);
$graph->legend->Pos(0.01,0.01);

$graph->Add($p1);
$graph->Stroke("graficos_grupos/percepsao.png");
?>